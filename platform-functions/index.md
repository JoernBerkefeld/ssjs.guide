...
`Platform.Function.Write` and `Platform.Function.Stringify` are documented alongside their global forms under [Global Functions](/global-functions/write/) and [Stringify](/global-functions/stringify/).
